...
<body class="login-bg min-h-screen flex items-center font-sans">
    ...
    <!-- Container dengan form di kanan, dengan padding atas agar logo Danantara & PLN terlihat -->
    <div class="w-full min-h-screen flex items-center justify-end pt-16 pb-8">
        <div class="mr-8 md:mr-16 lg:mr-24 xl:mr-32">
            <div class="glass-card rounded-2xl shadow-2xl p-10 animate-fadeInRight border border-white/20"
                ...
                @if (session('success'))
                    <div
                        class="bg-green-100/80 text-green-800 rounded-lg p-4 mb-4 flex items-center space-x-2 backdrop-blur">
                ...
                @if (session('error'))
                    <div
                        class="bg-red-100/80 text-red-800 rounded-lg p-4 mb-4 flex items-center space-x-2 backdrop-blur">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
