...
@section('breadcrumb', 'Saldo Material')
...
@push('styles')
    <style>
        ...
        .btn-action.success {
            background: linear-gradient(126.97deg, #68D391 28.26%, #48BB78 91.2%);
            color: white;
        }

        .btn-action.warning {
            background: linear-gradient(126.97deg, #F6AD55 28.26%, #ED8936 91.2%);
            color: white;
        }

        .btn-action.info {
            background: linear-gradient(126.97deg, #63B3ED 28.26%, #4299E1 91.2%);
            color: white;
        }

        .btn-action.danger {
            background: linear-gradient(126.97deg, #FC8181 28.26%, #F56565 91.2%);
            color: white;
        }
...
@section('content')
    ...
    <x-modal name="deleteModal" title="Konfirmasi Hapus" maxWidth="md">
        ...
        <div style="margin-bottom: 24px;">
            <p style="margin: 0 0 12px 0;">Apakah Anda yakin ingin menghapus material <strong id="materialName"></strong>?
            </p>
