                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nomor_kr" name="nomor_kr" 
                                           value="{{ old('nomor_kr') }}" placeholder="Masukkan Nomor KR">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pabrikan" name="pabrikan" 
                                           value="{{ old('pabrikan') }}" placeholder="Masukkan Pabrikan">
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control form-control-sm" 
                                                   name="materials[0][quantity]" placeholder="Qty" min="1" required>
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-sm" 
                                                   name="materials[0][satuan]" placeholder="Satuan" required>
                                        </td>
                                        <td>
