...
ASI.initForms = function() {
    ...
    $('form').on('submit', function() {
        $(this).find('.btn[type="submit"]').prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i> Memproses...');
    });
...
ASI.utils = {
    ...
    parseNumber: function(formattedNumber) {
        ...
        return parseFloat(formattedNumber.toString().replace(/[^\d,-]/g, '').replace(',', '.')) || 0;
    },
